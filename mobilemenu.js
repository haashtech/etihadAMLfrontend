;(function($) {
    ...
    $(document).ready(function() {
     ...
     //mobile-wrap
      ...
      const mobile_nav_close1 = $('.menu-close1');
      const mobile_nav_close2 = $('.menu-close2');
      const mobile_nav_close3 = $('.menu-close3');
      const mobile_nav_close4 = $('.menu-close4');
      const mobile_nav_close5 = $('.menu-close5');
      ...
      mobile_nav_close1.on('click', function(){
        mobile_sidebar.removeClass('mobile-menu-active');
      });
      mobile_nav_close2.on('click', function(){
        mobile_sidebar.removeClass('mobile-menu-active');
      });
      mobile_nav_close3.on('click', function(){
        mobile_sidebar.removeClass('mobile-menu-active');
      });
      mobile_nav_close4.on('click', function(){
        mobile_sidebar.removeClass('mobile-menu-active');
      });
      mobile_nav_close5.on('click', function(){
        mobile_sidebar.removeClass('mobile-menu-active');
      });
